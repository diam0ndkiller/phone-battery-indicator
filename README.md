...
This script connects to the first device from `phone_ips.txt` that has port 5542 open in adb `tcpip` mode. To use, enter you device's IP address into the file. To open the port, go into developer settings on your phone and enable USB debugging. Connect you phone via USB and authorize your PC for USB debugging. Then, on your PC, run
...
> [!NOTE]
> You will have to re-run this command every time your phone reboots.
